...
if (process.env.NEXT_PUBLIC_WEBAPP_URL) {
  env.NEXT_PUBLIC_WEBAPP_URL = ensureUrlProtocol(process.env.NEXT_PUBLIC_WEBAPP_URL);
}
...
if (process.env.NEXTAUTH_URL) {
  env.NEXTAUTH_URL = ensureUrlProtocol(process.env.NEXTAUTH_URL);
}
...
if (process.env.NEXT_PUBLIC_WEBSITE_URL) {
  env.NEXT_PUBLIC_WEBSITE_URL = ensureUrlProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL);
}
if (
